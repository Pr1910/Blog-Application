        ...
        <>
            ...
            <div className='w-full flex justify-center items-center h-[80vh]'>
                <div className='flex flex-col justify-center items-center space-y-4 w-[80%] md:w-[25%]'>
                    ...
                    <button className="w-full px-4 py-4 text-lg font-bold text-white bg-black rounded-lg border border-transparent hover:bg-white hover:border-2 hover:border-black hover:text-black ">Sign Up</button>
