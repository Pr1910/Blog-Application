        ...
        <>
            ...
            <div className='w-full flex justify-center items-center h-[80vh]'>
                <div className='flex flex-col justify-center items-center space-y-4 w-[80%] md:w-[25%]'>
                    ...
                    <button onClick={handleRegister} className="w-full px-4 py-4 text-lg font-bold text-white bg-black rounded-lg border border-transparent hover:bg-white hover:border-2 hover:border-black hover:text-black ">Sign Up</button>
                    {error && <h3 className='text-red-600 text-sm'>Something went wrong</h3>}
                    <div className='flex justify-center items-center space-x-3'>
                        <p>Already have an account?</p>
                        <p className='text-gray-500 font-bold hover:text-black'><Link to="/login">Login</Link></p>
                    </div>
                </div>
            </div>
