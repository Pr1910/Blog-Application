            ...
            {loader ? <div className='h-[80vh] flex justify-center items-center w-full'><Loader /></div> : <div className='px-8 md:px-[200px] mt-8'>
                <div className='flex justify-between items-center'>
                    ...
                    {user?._id === post?.userId && <div className="flex items-center justify-center space-x-2">
                        <p className="cursor-pointer" onClick={() => navigate("/edit/" + postId)} ><MdModeEdit /></p>
                ...
                <div className='w-full flex flex-col mt-4 md:flex-row'>
                    <input onChange={(e)=>setComment(e.target.value)} type='text' placeholder='Add a comment' className='md:w-[80%] outline-none py-2 px-4 mt-4 md:mt-0' />
