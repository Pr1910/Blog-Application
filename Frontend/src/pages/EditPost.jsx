        ...
        <div>
            ...
            <div className='px-6 md:px-[200px] mt-8'>
                ...
                <form className='w-full flex flex-col space-y-4 md:space-y-8 mt-4'>
                    <input type="text" placeholder='Post title' className='px-4 py-2 outline' />
                    ...
                    <textarea rows={15} cols={30} className='px-4 py-2 outline' placeholder='Enter post description' />
